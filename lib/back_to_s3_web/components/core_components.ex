defmodule BackToS3Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BackToS3Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BackToS3Web.Gettext, "errors", msg, opts)
    end
  end
